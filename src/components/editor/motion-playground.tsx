...
export function MotionPlayground() {
  ...
  return (
    <main className="min-h-screen bg-[#111216] text-white">
      ...
      <section className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-[290px_1fr_320px]">
        ...
        <aside className="border-l border-white/10 p-5">
          <div className="space-y-7">
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-xs leading-5 text-white/50">
              <strong className="text-white/80">Kinetiq project data:</strong> the chosen preset plus duration, stagger, and split mode are stored as neutral settings so the renderer stays portable.
            </div>
          </div>
        </aside>
      </section>
